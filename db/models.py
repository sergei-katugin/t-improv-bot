...
class Show(Base):
    ...
    # Kept for backward-compatible API payloads; registration chats always show full identity.
    registration_chat_name_mode = Column(String(16), nullable=False, default="full")
